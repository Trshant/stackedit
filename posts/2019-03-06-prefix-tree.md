...
```
As  we have written this, but we dont have the function `searchChildNodes` in the node class. So we will need to code that up.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMjAxNTUzMjgsLTI2MjY3NTYxXX0=
-->