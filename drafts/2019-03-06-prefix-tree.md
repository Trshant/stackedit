...
```
As you have probably noticed, the prefix_tree class requires the services of function `searchChildNodes` in the node class, which is not there in our first definition of node. So we will need to code that up.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3ODU2MjA4OTksLTI2MjY3NTYxLC0zNz
