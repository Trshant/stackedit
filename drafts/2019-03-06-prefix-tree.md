...
I will start by creating a node. At the least, this node should have the value of the element and a list of child nodes and a way to add to the child node list.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgwNzQzMjY1OSwtMjYyNjc1NjEsLTM3Nz
E1NDg0NywtMTQzMTU4NDkxMCwtMTMwOTE1NTU0LC0yOTI4NjQ2
NzYsLTYxNDIxMDk5NSwtOTQ2MTg2NDM5XX0=
-->